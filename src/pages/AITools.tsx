      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">
            Smart assistants to enhance your learning content
          </p>
        </div>
      </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-3">
                        ...
                        <div className="mt-2 text-sm text-gray-700">
                          <p>
                            Based on your training materials, the key steps for
                            handling customer complaints are:
                          </p>
                          <ol className="mt-2 ml-4 list-decimal space-y-1">
                            <li>
                              Listen actively and empathize with the customer's
                              concern
                            </li>
                            <li>Apologize sincerely for the inconvenience</li>
                            <li>
                              Ask clarifying questions to fully understand the
                              problem
                            </li>
                            <li>
                              Propose a solution or set clear expectations for
                              resolution
                            </li>
                          ...
                          <p className="mt-2">
                            ...
                            Excellence" course, Module 3: "Managing Difficult
                            Situations."
                          </p>
                        </div>
                  ...
                  <div className="mt-4">
                    ...
                    <div className="space-y-2">
                      {[
                        ...
                        <div
                          key={index}
                          className="p-2 bg-gray-50 rounded-md text-sm text-gray-700 hover:bg-gray-100 cursor-pointer"
                        >
                          {question}
                        </div>
                      ))}
                  ...
                  <div className="border-t border-gray-200 mt-6 pt-6">
                    ...
                    <div className="bg-gray-50 p-4 rounded-md min-h-[200px] mb-4">
                      ...
                      <p className="text-sm text-gray-700 mb-3">
                        Effective customer service is essential for maintaining
                        customer satisfaction and loyalty. This module covers
                        the fundamental principles and best practices for
                      ...
                      <ul className="list-disc pl-5 text-sm text-gray-700 space-y-1 mb-3">
                        ...
                        <li>
                          Master key communication skills for customer
                          interactions
                        </li>
                        <li>
                          Learn effective techniques for handling customer
                          complaints
                        </li>
                        <li>
                      ...
                      <p className="text-sm text-gray-700">
                        By the end of this module, participants will be equipped
                        with the knowledge and skills necessary to provide
                        outstanding customer service in various situations.
                      </p>
                    </div>
                ...
                <Card>
                  ...
                  <div className="border-t border-gray-200 pt-6">
                    ...
                    <div className="bg-gray-50 p-4 rounded-md mb-4">
                      ...
                      <p className="text-sm text-gray-700 mb-3">
                        Customer service plays a vital role in determining
                        business success. When implemented effectively, it
                      ...
                      <ul className="list-disc pl-5 text-sm text-gray-700 space-y-1 mb-4">
                        <li>
                          <strong>Active Listening:</strong> Truly understanding
                          customer needs and concerns
                        </li>
                        <li>
                          <strong>Prompt Resolution:</strong> Solving customer
                          problems efficiently and effectively
                        </li>
                        <li>
                          <strong>Professional Demeanor:</strong> Maintaining a
                      ...
                      <div className="bg-red-50 border-l-4 border-red-500 p-3 mb-4">
                        <p className="text-sm text-red-700 font-medium">
                          Warning: Poor customer service can lead to customer
                          churn and significantly impact revenue.
                        </p>
                      </div>
