...
import { FileText, Image, Film, Clock, Edit3, ListChecks, AlignLeft, Copy, Plus, ChevronDown, ChevronRight } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">Create and edit training content</p>
        </div>
        ...
        <div className="p-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="p-2 border-l-4 border-gray-200 rounded flex items-center">
                      <div className="flex-1">
                        <div className="flex items-center">
                          ...
                          <span className="font-medium">Module 1: Fundamentals</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="p-2 border-l-4 border-gray-200 rounded flex items-center">
                      <div className="flex-1">
                        <div className="flex items-center">
                          <ChevronRight size={16} className="mr-2 text-gray-400" />
                          <span className="font-medium">Module 2: Advanced Concepts</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="p-2 border-l-4 border-gray-200 rounded flex items-center">
                      <div className="flex-1">
                        <div className="flex items-center">
                          <ChevronRight size={16} className="mr-2 text-gray-400" />
                          <span className="font-medium">Module 3: Practical Applications</span>
                        </div>
                      </div>
                    </div>
                ...
                <Card>
                  ...
                  <div className="bg-blue-50 p-4 rounded-md mb-4">
                    <div className="flex items-start">
                      ...
                      <div className="ml-3">
                        <h3 className="text-sm font-medium text-blue-800">AI Content Assistant</h3>
          ...
          {activeTab === 'tests' && (
            <div>
              ...
              <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                {[
                  { id: 1, title: 'Final Assessment', questions: 15, type: 'Multiple Choice', time: '30 min' },
                  { id: 2, title: 'Module 1 Quiz', questions: 8, type: 'Multiple Choice', time: '15 min' },
                  { id: 3, title: 'Knowledge Check', questions: 5, type: 'True/False', time: '10 min' },
                  { id: 4, title: 'Skills Assessment', questions: 12, type: 'Mixed', time: '25 min' },
                  { id: 5, title: 'Feedback Survey', questions: 10, type: 'Open-ended', time: '20 min' },
                  { id: 6, title: 'Quick Check', questions: 3, type: 'Single Choice', time: '5 min' },
                ].map((test) => (
          ...
          {activeTab === 'templates' && (
            <div>
              ...
              <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                {[
                  { id: 1, title: 'Onboarding Template', modules: 4, lastUsed: '2 days ago' },
                  { id: 2, title: 'Product Training', modules: 6, lastUsed: '1 week ago' },
                  { id: 3, title: 'Compliance Course', modules: 3, lastUsed: '3 days ago' },
                  { id: 4, title: 'Leadership Development', modules: 8, lastUsed: '2 weeks ago' },
                  { id: 5, title: 'Customer Service', modules: 5, lastUsed: 'Never used' },
                  { id: 6, title: 'Basic Skills', modules: 4, lastUsed: '1 month ago' },
                ].map((template) => (
